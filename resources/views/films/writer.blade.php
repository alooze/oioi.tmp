...
@section('block_content')
  <div class="dashboard__info-form">
    @if (!count($writers = $film->personnel('writer')))
      <div class="dashboard__info-form__inner dashboard__info-form__inner--empty"><img class="img-responsive dashboard-img-team__empty" src="data:image/png;base64," width="46">
        <p class="dashboard__empty-descr">No writer is added yet...</p>
        <div class="justify-center">
          <button class="btn btn-secondary" type="button" data-show-modal="add-writer-modal"><span class="plus">+</span>Add Writer</button>
        </div>
      </div>
    @else
      <div class="dashboard__info__table">
        <div class="dashboard__info__table-div">Writer name</div>
          ...
          @foreach ($writers as $W)
            <li>
              ...
              <div class="dashboard__info__table-list-action">
                <button class="btn btn-edit" type="button" id="js__edit-person" data-show-modal="edit-writer-modal" data-pid="{{ $W->id }}">Edit</button>
                <button class="btn btn-del" type="button" id="js__delete-person" data-show-modal="delete-writer-modal" data-pid="{{ $W->id }}">Delete</button>
              </div>
            </li>
          @endforeach
        </ul>
...
@section('modals')
  <div class="modal" id="add-writer-modal">
    <div class="modal-dialog animated">
      <div class="modal-content modal-content--primary">
          <div class="modal-top">
              <h2 class="modal-title-form">Writer</h2>
          ...
          <div class="tabs-wrap"><span>Writer is:</span>
              <div class="tabs-list flex" role="tablist">
                @if (!$film->hasMeAs('writer'))
          ...
          <form action="{{ $attachRoute }}" method="POST" class="modal-content__form tab-pane active" id="form-someone-else" data-form-validate data-form-no-ajax="true">
              ...
              <div class="dashboard__info-form-wrap dashboard__info-form-wrap--half form-group">
                  <p class="dashboard__info-form-descr">Writer's Email *</p>
  ...
  <div class="modal" id="edit-writer-modal" data-modal-type="edit">
    <div class="modal-dialog animated bounceInDown">
      <div class="modal-content modal-content--primary">
          <div class="modal-top">
              <h2 class="modal-title-form">Editing writer</h2>
              <div class="modal-close modal-close--primary" data-hide-modal>
                <svg width="18" height="18" viewBox="0 0 13.25 13.25">
                  <path d="M956.1,3403.37l0.53,0.53L943.9,3416.63l-0.53-.53Z" transform="translate(-943.375 -3403.38)"></path>
                  <path d="M943.9,3403.37l12.728,12.73-0.53.53-12.728-12.73Z" transform="translate(-943.375 -3403.38)"></path>
          ...
          <form action="{{ route('f.films.editPerson', ['id' => $film->id, 'step' => $step]) }}" method="POST" class="modal-content__form tab-pane active" id="form-someone-else-edit" data-form-validate data-form-no-ajax="true">
              ...
              <div class="dashboard__info-form-wrap dashboard__info-form-wrap--half">
                  <p class="dashboard__info-form-descr">IMDB link</p>
                  {{ Form::text('imdb_link', '', ['id' => 'js__edit-person-imdb_link']) }}
              </div>
              <div class="dashboard__info-form-wrap dashboard__info-form-wrap--full">
                  <div class="pull-right flex">
                      <button class="btn btn-l" type="button" data-hide-modal>Cancel</button>
  ...
  <div class="modal" id="delete-writer-modal" data-modal-type="delete">
    <div class="modal-dialog animated">
