          ...
          @foreach ($directors as $D)
            <li {{ $D->is_me ? 'data-is-me' : '' }}>
              ...
              <div class="dashboard__info__table-list-email">
                  {{ $D->email }} 
                  @if ($D->email_confirmed == 1)
                  <span class="icon-verified" data-title="Email is verified"></span>
                  @endif
              </div>
              ...
              <div class="dashboard__info__table-list-action">
                <button class="btn btn-edit" type="button" id="js__edit-person" data-show-modal="edit-director-modal" data-pid="{{ $D->id }}">Edit</button>
                <button class="btn btn-del" type="button" id="js__delete-person" data-show-modal="delete-director-modal" data-pid="{{ $D->id }}">Delete</button>
              </div>
            </li>
          @endforeach
        </ul>
...
@section('modals')
  <div class="modal" id="add-director-modal">
    <div class="modal-dialog animated">
      <div class="modal-content modal-content--primary">
          <div class="modal-top">
              <h2 class="modal-title-form">Director</h2>
              <div class="modal-close modal-close--primary" data-hide-modal><svg width="18" height="18" viewBox="0 0 13.25 13.25">
          ...
          <div class="tabs-wrap"><span>Director is:</span>
            <div class="tabs-list" role="tablist">
              @if (!$film->hasMeAs('director'))
              <a href="#form-me" data-toggle="tab">ME</a>
              @endif
              <a href="#form-someone-else" class="active" data-toggle="tab">someone else</a>
            </div>
          </div>
          @if (!$film->hasMeAs('director'))
          <form action="{{ $attachRoute }}" method="POST" class="modal-content__form tab-pane" id="form-me" data-form-validate data-form-no-ajax="true">
              {{ csrf_field() }}
          ...
          <form action="{{ $attachRoute }}" method="POST" class="modal-content__form tab-pane active" id="form-someone-else" data-form-validate data-form-no-ajax="true">
              {{ csrf_field() }}
              ...
              <div class="dashboard__info-form-wrap dashboard__info-form-wrap--half">
                  ...
                  <div id="js__country-select">
                      {{ Form::select('country', $countries, '', [ 'id' => 'form-someone-else-country', 'placeholder' => 'Choose country',
              ...
              <div class="dashboard__info-form-wrap dashboard__info-form-wrap--half">
                  ...
                  <div id="js__city-select">
                      {{ Form::select('city', [], '', [ 'id' => 'form-someone-else-city', 'data-class-names-container-outer' => 'choices choices_with-border',
  ...
  <div class="modal" id="edit-director-modal" data-modal-type="edit">
    <div class="modal-dialog animated">
      <div class="modal-content modal-content--primary">
          <div class="modal-top">
              <h2 class="modal-title-form">Editing director</h2>
              <div class="modal-close modal-close--primary" data-hide-modal><svg width="18" height="18" viewBox="0 0 13.25 13.25">
          <path d="M956.1,3403.37l0.53,0.53L943.9,3416.63l-0.53-.53Z" transform="translate(-943.375 -3403.38)"></path>
          <path d="M943.9,3403.37l12.728,12.73-0.53.53-12.728-12.73Z" transform="translate(-943.375 -3403.38)"></path>
        </svg></div>
          ...
          <form action="{{ route('f.films.editPerson', ['id' => $film->id, 'step' => $step]) }}" method="POST" class="modal-content__form tab-pane" id="form-me-edit" data-form-validate data-form-no-ajax="true">
              ...
              {{ Form::hidden('pid') }}
               <div class="dashboard__info-form-wrap dashboard__info-form-wrap--half form-group">
                 ...
                 <div class="dashboard__info-form-wrap dashboard__info-form-wrap--half form-group">
                     <p class="dashboard__info-form-descr">Email * <span class="icon-verified" data-title="Email is verified by producer"></span></p>
                     {{ Form::email('email', $user->email, [ 'data-rules' => 'required|valid_email', ($user->email == null) ? '' : 'readonly']) }}
                 </div>
                 <div class="dashboard__info-form-wrap dashboard__info-form-wrap--half form-group">
                     <p class="dashboard__info-form-descr">Mobile number *</p>
  ...
  <div class="modal" id="delete-director-modal" data-modal-type="delete">
    <div class="modal-dialog animated">
      <div class="modal-content">
        ...
        <p class="modal-descr">Do you really want to delete <b id="js__delete-person-name"></b> from the list?</p>
        <div>
          <form action="{{ route('f.films.dettachPerson', ['id' => $film->id, 'step' => $step]) }}" method="POST">
            {{ csrf_field() }}
            {{ Form::hidden('pid', '', ['id' => 'js__delete-person-id']) }}
