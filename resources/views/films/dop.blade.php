...
@section('block_content')
  <div class="dashboard__info-form">
    @if (!count($dops = $film->personnel('dop')))
      <div class="dashboard__info-form__inner dashboard__info-form__inner--empty"><img class="img-responsive dashboard-img-team__empty" src="data:image/png;base64," width="46">
        <p class="dashboard__empty-descr">No DOP is added yet...</p>
        <div class="justify-center">
          <button class="btn btn-secondary" type="button" data-show-modal="add-dop-modal"> <span class="plus">+  </span>Add DOP</button>
        </div>
      </div>
    @else
      <div class="dashboard__info__table">
        <div class="dashboard__info__table-div">Dop name</div>
          ...
          @foreach ($dops as $DP)
            <li>
              ...
              <div class="dashboard__info__table-list-action">
                <button class="btn btn-edit" type="button" id="js__edit-person" data-show-modal="edit-dop-modal" data-pid="{{ $DP->id }}">Edit</button>
                <button class="btn btn-del" type="button" id="js__delete-person" data-show-modal="delete-dop-modal" data-pid="{{ $DP->id }}">Delete</button>
              </div>
            </li>
          @endforeach
        </ul>
...
@section('modals')
  <div class="modal" id="add-dop-modal">
    <div class="modal-dialog animated">
      <div class="modal-content modal-content--primary">
          <div class="modal-top">
            <h2 class="modal-title-form">DOP</h2>
            <button class="modal-close modal-close--primary" data-hide-modal>
          ...
          <div class="tabs-wrap"><span>DOP is:</span>
          ...
          <form action="{{ $attachRoute }}" method="POST" class="modal-content__form tab-pane" id="form-me" data-form-validate data-form-no-ajax="true">
              ...
              <div class="dashboard__info-form-wrap dashboard__info-form-wrap--half">
                  <p class="dashboard__info-form-descr">Showreel link</p>
                  {{ Form::text('showreel_link') }}
              </div>
          ...
          <form action="{{ $attachRoute }}" method="POST" class="modal-content__form tab-pane active" id="form-someone-else" data-form-validate data-form-no-ajax="true">
              ...
              <div class="dashboard__info-form-wrap dashboard__info-form-wrap--half form-group">
                  <p class="dashboard__info-form-descr">DOP's Email *</p>
  ...
  <div class="modal" id="edit-dop-modal" data-modal-type="edit">
    <div class="modal-dialog animated">
      <div class="modal-content modal-content--primary">
        <div class="modal-top">
          <h2 class="modal-title-form">Editing DOP</h2>
          <button class="modal-close modal-close--primary" data-hide-modal>
            <svg width="18" height="18" viewBox="0 0 13.25 13.25">
              <path d="M956.1,3403.37l0.53,0.53L943.9,3416.63l-0.53-.53Z" transform="translate(-943.375 -3403.38)"></path>
              <path d="M943.9,3403.37l12.728,12.73-0.53.53-12.728-12.73Z" transform="translate(-943.375 -3403.38)"></path>
  ...
  <div class="modal" id="delete-dop-modal" data-modal-type="delete">
    <div class="modal-dialog animated">
